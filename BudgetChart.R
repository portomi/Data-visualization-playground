...
dat <- data.frame(ChineseTrain <- 750*10^9,
Paks2 <- 311.3*10^10,
MeszarosLoLo <- 381.3*10^9,
Csanyi <- 317.2*10^9,
JeffBezos <- 264.8*131*10^9,
GySoros <- 2264.8*8*10^9,
TunnelChaneBridge_planned <- 23*10^9,
VizesVB <- 103*10^9,
DunaArena <- 46*10^9, #included in VizesVB
Puskas_planned <- 100*10^9,
Puskas_now <- 143*10^9,
HospitalRenovation_StImre <- 6.8*10^9,
HospitalRenovation_Sport <- 10^10,
HospitalRenovation_total <- 114.5*10^9,
